class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    print('🏗️ [DEBUG] Creating User from JSON: $json');
    try {
      // ✅ FIX: Handle proper login response structure
      ...
      if (json.containsKey('user')) {
        print('📦 [DEBUG] Detected login/register response structure');
      ...
      // Case 2: Direct user data: {id: 1, nama: "...", email: "...", ...}
        ...
        print('📦 [DEBUG] Detected direct user structure');
        userData = json;
      ...
      print('✅ [DEBUG] User created successfully: ${user.toString()}');
      return user;
    } catch (e, stackTrace) {
      print('❌ [DEBUG] Error creating User from JSON: ${e.toString()}');
